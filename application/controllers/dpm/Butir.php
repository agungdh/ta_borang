...
class Butir extends CI_Controller {
	...
	function index($substandar_id) {
		$data['nav'] = "dpm/butir/nav";
		$data['isi'] = "dpm/butir/index";
	...
	function aksi_tambah() {
		...
		redirect(base_url('dpm/butir/index/' . $data['substandar_id']));
	}
	...
	function aksi_hapus($id) {
		...
		redirect(base_url('dpm/butir/index/' . $substandar_id));
	}
