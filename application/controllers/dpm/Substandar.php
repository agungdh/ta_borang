...
class Substandar extends CI_Controller {
	...
	function index($standar_id) {
		$data['nav'] = "dpm/substandar/nav";
		$data['isi'] = "dpm/substandar/index";
	...
	function aksi_tambah() {
		...
		redirect(base_url('dpm/substandar/index/' . $data['standar_id']));
	}
	...
	function aksi_hapus($id) {
		...
		redirect(base_url('dpm/substandar/index/' . $standar_id));
	}
