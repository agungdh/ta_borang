...
<li><a class="app-menu__item" href="<?php echo base_url('fakultas'); ?>"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Fakultas</span></a></li>

<li><a class="app-menu__item" href="<?php echo base_url('versi'); ?>"><i class="app-menu__icon fa fa-gears"></i><span class="app-menu__label">Standar Akreditasi</span></a></li>
