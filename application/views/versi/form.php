<div class="col-md-12">
	...
	<div class="m-portlet m-portlet--tab">
		...
		<!--begin::Form-->
		<form class="m-form m-form--fit m-form--label-align-right" method="post" action="<?php echo base_url('versi/aksi_' . $aksi); ?>">
			...
			<div class="m-portlet__foot m-portlet__foot--fit">
				<div class="m-form__actions">
					...
					<a href="<?php echo base_url('versi'); ?>" class="btn btn-secondary">
						Kembali
					</a>
				</div>
			</div>
