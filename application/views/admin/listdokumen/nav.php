...
<li class="m-nav__item">
	<a href="<?php echo base_url('admin/butir/index/' . $data['substandar']->id); ?>" class="m-nav__link" data-toggle="m-tooltip" title="<?php echo $data['butir']->nomor . ' ' . $data['butir']->nama; ?>">
		<span class="m-nav__link-text">
			Butir
		</span>
	</a>
...
<li class="m-nav__item">
	<a href="<?php echo base_url('admin/listdokumen/index/' . $data['butir']->id); ?>" class="m-nav__link" data-toggle="m-tooltip">
		<span class="m-nav__link-text">
			List Dokumen
		</span>
	</a>
