...
<li class="m-nav__item">
	...
	?>
	<a href="<?php echo base_url('prodi/pengajuan'); ?>" class="m-nav__link" data-toggle="m-tooltip" title="<?php echo $this->pustaka->tanggal_indo($data['pengajuan']->tanggal_pengajuan) . ' - ' . $fakultas_prodi . ' - ' . $data['pengajuan']->tahun_usulan . ' - ' . $versi->nama . ' (' . $versi->tahun . ')' . ' - ' . $persentase . '%'; ?>">
