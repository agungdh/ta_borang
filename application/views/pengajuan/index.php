				...
				<tbody>
					...
					foreach ($data['pengajuan'] as $item) {
						...
						<tr>
							...
							<td>
								<a href="<?php echo base_url('detail_pengajuan/index/' .  $item->id); ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="m-tooltip" title="Detail Pengajuan">
