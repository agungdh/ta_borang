...
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      <h3 class="tile-title">Ubah Butir</h3>
      <div class="tile-body">
        <form method="post" action="<?php echo base_url('butir/aksi_ubah'); ?>">
          
          <input type="hidden" name="where[id]" value="<?php echo $data['butir']->id; ?>">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" required placeholder="Masukan Nama" name="data[nama]" value="<?php echo $data['butir']->nama; ?>">
          </div>
