			...
			<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
				<div class="row align-items-center">
					...
					<div class="col-xl-4 order-1 order-xl-2 m--align-right">
						<a href="<?php echo base_url('dpm/pengajuan/tambah'); ?>" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
							<span>
				...
				<tbody>
					...
					foreach ($data['pengajuan'] as $item) {
						...
						<tr>
							...
							<td>
								<a href="<?php echo base_url('dpm/detail_pengajuan/index/' .  $item->id); ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="m-tooltip" title="Detail Pengajuan">
									<i class="la la-external-link"></i>
								</a>
								<a href="<?php echo base_url('dpm/detail_pengajuan/unduh_semua/' .  $item->id); ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="m-tooltip" title="Unduh Semua Berkas">
...
function hapus(id) {
    swal({
        ...
        if (result.value) {
            window.location = "<?php echo base_url('dpm/pengajuan/aksi_hapus/'); ?>" + id;
        }
    });
};
</script>
